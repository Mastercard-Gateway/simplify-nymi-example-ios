...
//#define kLocalIp @"10.18.24.92"
#define kLocalIp @"10.157.193.216"
...
- (IBAction)buyCupcake:(id)sender {
    ...
    SIMChargeCardViewController *chargeController = [[SIMChargeCardViewController alloc] initWithPublicKey:@"INSERT_PUBLIC_KEY" primaryColor:nil];
...
-(void)creditCardTokenProcessed:(SIMCreditCardToken *)token {
    ...
    NSURL *url= [NSURL URLWithString:@"INSERT_OWN_HOST"];
